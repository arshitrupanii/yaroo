...
import { deleteMessage, editMessage, getUserFromSidebar, getSearchUser, getMessage, markMessagesSeen, sendGroupMessage, sendMessage } from '../controllers/message.controller.js';
...
router.post('/group/:id/send', authMiddleware, asyncHandler(sendGroupMessage));
